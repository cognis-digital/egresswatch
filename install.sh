#!/usr/bin/env sh
# Universal installer for egresswatch. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/egresswatch.git"
echo "Installing egresswatch ..."
...
echo "Done. Run: egresswatch --help"
